...
F1DataVis.IdStore.ButtonNormalURL =
    'url(#' + F1DataVis.IdStore.ButtonNormal + ')';
F1DataVis.IdStore.ButtonPressedURL =
    'url(#' + F1DataVis.IdStore.ButtonPressed + ')';
F1DataVis.IdStore.ButtonHoverURL =
    'url(#' + F1DataVis.IdStore.ButtonHover + ')';
F1DataVis.IdStore.DashBoardGradURL =
    'url(#' + F1DataVis.IdStore.DashBoardGrad + ')';
F1DataVis.IdStore.TooltipGradURL =
    'url(#' + F1DataVis.IdStore.TooltipGrad + ')';

F1DataVis.IdStore.LogoNormalURL = 'url(#' + F1DataVis.IdStore.LogoNormal + ')';
F1DataVis.IdStore.LogoPressedURL =
    'url(#' + F1DataVis.IdStore.LogoPressed + ')';
...
F1DataVis.f1Visualizer = function (parentSvg) {
    var self = this,
        ...
        _createStyles = function () {
            var defs = document.getElementById(F1DataVis.IdStore.defs),
                linearGrad,
                stopElement;
            // Normal gradient
            linearGrad = document.createElementNS(
                'http://www.w3.org/2000/svg',
                'linearGradient'
            );
            linearGrad.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.ButtonNormal
            );
            ...
            stopElement = document.createElementNS(
                'http://www.w3.org/2000/svg',
                'stop'
            );
            ...
            linearGrad.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.ButtonPressed
            );
            linearGrad.setAttributeNS(null, 'x1', '0%');
            linearGrad.setAttributeNS(null, 'x2', '0%');
            linearGrad.setAttributeNS(null, 'y1', '0%');
            ...
            linearGrad.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.DashBoardGrad
            );
            linearGrad.setAttributeNS(null, 'x1', '0%');
            linearGrad.setAttributeNS(null, 'x2', '0%');
            linearGrad.setAttributeNS(null, 'y1', '0%');
            ...
            stopElement.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.LogoNormal + '_1'
            );
            stopElement.setAttributeNS(null, 'offset', '0%');
            stopElement.setAttributeNS(null, 'stop-color', 'Black');
            linearGrad.appendChild(stopElement);
            ...
            stopElement.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.LogoNormal + '_2'
            );
            ...
            stopElement.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.LogoNormal + '_3'
            );
            stopElement.setAttributeNS(null, 'offset', '100%');
            ...
            stopElement.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.LogoHover + '_1'
            );
            stopElement.setAttributeNS(null, 'offset', '0%');
            stopElement.setAttributeNS(null, 'stop-color', '#061f37');
            linearGrad.appendChild(stopElement);
            ...
            stopElement.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.LogoHover + '_2'
            );
            stopElement.setAttributeNS(null, 'offset', '100%');
            stopElement.setAttributeNS(null, 'stop-color', 'Black');
            linearGrad.appendChild(stopElement);
            ...
            stopElement.setAttributeNS(
                null,
                'id',
                F1DataVis.IdStore.LogoHover + '_3'
            );
            stopElement.setAttributeNS(null, 'offset', '100%');
            stopElement.setAttributeNS(null, 'stop-color', '#E70000');
            linearGrad.appendChild(stopElement);
    ...
    this.initialize = function (width, height) {
        this.width = width;
        this.height = height;
        _visualizationGrp = d3
            .select(this.parentSvg)
            .append('g')
        ...
        this.parallelCoords = new F1DataVis.paraCoorder(
            _visualizationGrp,
            this
        );
        this.introducer = new F1DataVis.introducer(
            _introGrp,
            _logoStyles,
            this
        );
    ...
    this.sliderMoved = function (year) {
        F1DataVis.dataHandler.getRaceIdsInYear(year);
