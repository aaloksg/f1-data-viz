...
F1DataVis.timeSlider = function (parent, visualizer) {
    ...
    var _height = 0,
        ...
        _tweakSliderLook = function () {
            ...
            _parent.selectAll('.tick line').attr('opacity', 0);
        ...
        _getDashBoardPositions = function () {
            ...
            _dashPath.push([
                -_visualizer.width / 2,
                self.yPosition + _marginProps.top / 2,
            ]);
            //Dummy points
            _dashPath.push([
                -_visualizer.width / 2,
    ...
    this.draw = function () {
        ...
        _sliderGroup._groups[0][0].getBBox().width;
        this.yPosition =
            _visualizer.height -
            _height -
            _marginProps.bottom -
    ...
    this.update = function () {
        var width = _visualizer.width;
        _timeSlider.value();
        _timeSlider.width(width - _marginProps.left - _marginProps.right);
        _sliderGroup.attr(
            'transform',
            'translate(' + _xPos + ',' + _yPos + ')'
        );
